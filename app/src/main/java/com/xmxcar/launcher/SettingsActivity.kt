...
class SettingsActivity : AppCompatActivity() {
     ...
     * 设置悬浮音乐开关
     */
    private fun setupFloatingMusicSwitch() {
        val switchFloatingMusic = findViewById<Switch>(R.id.switch_floating_music)
        val prefs = getSharedPreferences("panda_floating_music", MODE_PRIVATE)
        switchFloatingMusic?.isChecked = prefs.getBoolean("enabled", false)

        switchFloatingMusic?.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (isChecked) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(this)) {
                    ...
                    startActivity(intent)
                    Toast.makeText(this, R.string.floating_music_no_permission, Toast.LENGTH_LONG).show()
                    switchFloatingMusic.isChecked = false
                    return@setOnCheckedChangeListener
                }
                ...
                Toast.makeText(this, R.string.floating_music_started, Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun setupFloatingMapSwitch() {
        ...
        switchFloatingMap?.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (isChecked) {
                ...
                val intent = Intent(this, com.xmxcar.floating.FloatingForegroundService::class.java)
