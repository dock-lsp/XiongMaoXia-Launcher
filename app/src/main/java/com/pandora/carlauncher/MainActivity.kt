...
class MainActivity : AppCompatActivity() {
    ...
    private var isFloatingMusicRunning = false
    ...
    private fun setupCardClicks() {
        ...
        // 音乐卡片悬浮按钮 - 启动/停止悬浮音乐
        findViewById<View>(R.id.btn_floating_music)?.setOnClickListener {
            toggleFloatingMusic()
        }
    }
     ...
     * 启动悬浮音乐
     */
    private fun startFloatingMusic() {
     ...
     * 停止悬浮音乐
     */
    private fun stopFloatingMusic() {
        stopService(Intent(this, FloatingMusicService::class.java))
        isFloatingMusicRunning = false
